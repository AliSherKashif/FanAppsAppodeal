 ...
 */
public class TabletFacebookFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tablet_horizontal_facebook, container, false);
        ...
        final String url = Config.facebookLink;
        startWebView(url);
