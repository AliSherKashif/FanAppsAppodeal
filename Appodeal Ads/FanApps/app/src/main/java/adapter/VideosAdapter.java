...
import com.mm.fanapps.fanapps.activities.youtube.widget.UrlImageView;
...
public class VideosAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = mInflater.inflate(R.layout.list_item_user_video_picaso, null);
		}
		...
		Picasso.with(context).load(video.getThumbUrl()).placeholder(R.drawable.ic_progress).error(R.drawable.ic_thumbnail).into(thumb);
